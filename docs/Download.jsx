function Download() {
  ...
  const getMacUrl = (detectedArch) => {
    ...
    return `https://github.com/salvatorecorvaglia/lunar/releases/download/v0.1.0/lunar-0.1.0-mac-${macArch}.dmg`;
  };

  const getLinuxUrl = (detectedArch) => {
    return `https://github.com/salvatorecorvaglia/lunar/releases/download/v0.1.0/lunar-0.1.0-linux-${detectedArch}.AppImage`;
  };
  ...
  const platforms = [
    ...
    },
    {
      ...
      url: 'https://github.com/salvatorecorvaglia/lunar/releases/download/v0.1.0/lunar-0.1.0-win-x64-setup.exe',
