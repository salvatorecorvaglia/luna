function Download() {
  ...
  const getMacUrl = (detectedArch) => {
    ...
    return `https://github.com/salvatorecorvaglia/lunar/releases/download/v0.2.1/lunar-0.2.1-mac-${macArch}.dmg`;
  };

  const getLinuxUrl = (detectedArch) => {
    return `https://github.com/salvatorecorvaglia/lunar/releases/download/v0.2.1/lunar-0.2.1-linux-${detectedArch}.AppImage`;
  };
  ...
  const platforms = [
    ...
    },
    {
      ...
      url: 'https://github.com/salvatorecorvaglia/lunar/releases/download/v0.2.1/lunar-0.2.1-win-x64-setup.exe',
