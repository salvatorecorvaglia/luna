...
import { COLOR_OPTIONS } from './connection-form.constants';
  ...
  return (
    <>
      <DialogShell
        ...
        zLayer={Z.modal}
        // An outside click on a dirty form gets the same discard confirmation
        // as Escape and the header's close button, not a silent data loss —
        // `requestClose` is what enforces that.
        dismissOnOverlayClick
        ariaLabelledBy="connection-form-title"
        panelClassName="no-drag flex flex-col w-full max-w-lg max-h-[85vh] rounded-xl border border-border/80 bg-card shadow-xl overflow-hidden"
      >
        {/* Header */}
        <div className="flex shrink-0 items-center justify-between border-b border-border/60 px-5 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <h2 id="connection-form-title" className="text-base font-semibold text-foreground">
              {isEditing
                ? 'Edit Connection'
                : duplicatingConnection
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-5">
            ...
            <div>
              ...
              <div
                ...
                role="radiogroup"
                aria-labelledby="conn-provider-label"
              >
                <button
                  type="button"
                  role="radio"
            ...
            <div>
              ...
              <div
                ...
                role="radiogroup"
                aria-labelledby="conn-color-tag-label"
              >
                      ...
                      {uniqueFolders.map((f) => (
                        <motion.button
                          ...
                          className={cn(
                            ...
                            common.folder === f || (f === 'default' && common.folder === 'default')
          ...
          {testResult && (
            ...
            >
              {testResult.status === 'success' ? (
                <CheckCircle2 className="size-4 shrink-0 text-success mt-0.5" aria-hidden="true" />
              ) : (
                <AlertCircle
              ...
              <IconButton
                ...
                className="!p-0.5 !min-w-0 !min-h-0 -mr-0.5 -mt-0.5"
